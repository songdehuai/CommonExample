package com.songdehuai.widget.myrefreshlayout.header.progresslayout;
...
import com.songdehuai.widget.myrefreshlayout.IHeaderView;
import com.songdehuai.widget.myrefreshlayout.OnAnimEndListener;
 ...
 *
 * @author songdehuai
 * @ClassName: com.songdehuai.myrefreshlayout.header.progresslayout.ProgressLayout
 * @date 2017/8/14 12:13
 */
...
public class ProgressLayout extends FrameLayout implements IHeaderView {
    ...
    public ProgressLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setColorSchemeResources(R.color.Blue,R.color.Green,R.color.Orange,R.color.Orange);
    }
