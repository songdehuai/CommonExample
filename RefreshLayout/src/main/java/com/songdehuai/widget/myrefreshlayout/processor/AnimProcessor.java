 ...
 *
 * @author songdehuai
 * @ClassName: com.songdehuai.myrefreshlayout.widget.refresh.processor.AnimProcessor
 * @date 2017/8/14 11:12
 */
public class AnimProcessor implements IAnimRefresh, IAnimOverScroll {

    private MyRefreshLayout.CoContext cp;
    private static final float animFraction = 1f;
    //动画的变化率
    private DecelerateInterpolator decelerateInterpolator;

    public AnimProcessor(MyRefreshLayout.CoContext coProcessor) {
        this.cp = coProcessor;
