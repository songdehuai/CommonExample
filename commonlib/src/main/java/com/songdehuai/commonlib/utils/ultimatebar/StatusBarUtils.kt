...
object StatusBarUtils {
    ...
    internal fun setBarDrawable(
        ...
        setBar(
            activity, statusDark, statusDrawable, statusDrawable2, applyNavigation,
     ...
     * @param navigationDrawable2 Android 8.0 以下导航栏灰色模式时导航栏背景
     */
    internal fun setBarTransparent(
        activity: Activity,
        statusDark: Boolean = false,
        statusDrawable: Drawable? = null,
        statusDrawable2: Drawable? = statusDrawable,
        ...
        setBar(
            activity, statusDark, statusDrawable, statusDrawable2, applyNavigation, navigationDark,
    ...
    internal fun setBarImmersion(
        ...
        setBarTransparent(
            activity, statusDark, null, statusDrawable2,
     ...
     * @param navigationDrawable2 Android 8.0 以下导航栏灰色模式时导航栏背景
     */
    internal fun setBarDrawableDrawer(
        activity: Activity,
