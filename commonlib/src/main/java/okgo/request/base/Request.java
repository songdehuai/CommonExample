...
import okgo.OkGo;
import okgo.adapter.AdapterParam;
import okgo.adapter.CacheCall;
import okgo.adapter.Call;
import okgo.adapter.CallAdapter;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public Request(String url) {
        this.url = url;
        baseUrl = url;
        OkGo go = OkGo.Companion.getInstance();
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = OkGo.Companion.getInstance().getOkHttpClient();
